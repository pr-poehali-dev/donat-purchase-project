...
const donateItems: DonateItem[] = [
  {
    id: 1,
    title: 'Владелец',
    description: 'Полный контроль над системой. Назначение всех рангов.',
    price: 0,
    icon: 'Crown',
  ...
  },
  {
    id: 2,
    title: 'Администратор',
    description: 'Управление донатами и изменение названий',
    price: 999,
    icon: 'Shield',
  ...
  },
  {
    id: 3,
    title: 'Поддержка',
    description: 'Работа с чатом техподдержки и помощь пользователям',
    price: 499,
    icon: 'Headphones',
